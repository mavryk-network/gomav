...
func (self *BlockHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.BlockHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self BlockHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.BlockHash, self[:])
}
...
func (self *BlockHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.BlockHash {
		return fmt.Errorf("gomav: invalid BlockHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *OperationHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.OperationHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self OperationHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.OperationHash, self[:])
}
...
func (self *OperationHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.OperationHash {
		return fmt.Errorf("gomav: invalid OperationHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *OperationsHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.OperationListListHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self OperationsHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.OperationListListHash, self[:])
}
...
func (self *OperationsHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.OperationListListHash {
		return fmt.Errorf("gomav: invalid OperationsHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *ContextHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.ContextHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self ContextHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.ContextHash, self[:])
}
...
func (self *ContextHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.ContextHash {
		return fmt.Errorf("gomav: invalid ContextHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *ChainID) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.ChainID, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self ChainID) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.ChainID, self[:])
}
...
func (self *ChainID) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.ChainID {
		return fmt.Errorf("gomav: invalid ChainID encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *BlockPayloadHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.ValueHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self BlockPayloadHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.ValueHash, self[:])
}
...
func (self *BlockPayloadHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.ValueHash {
		return fmt.Errorf("gomav: invalid BlockPayloadHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *CycleNonceHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.CycleNonce, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self CycleNonceHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.CycleNonce, self[:])
}
...
func (self *CycleNonceHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.CycleNonce {
		return fmt.Errorf("gomav: invalid CycleNonceHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *Ed25519PublicKeyHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.Ed25519PublicKeyHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self Ed25519PublicKeyHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.Ed25519PublicKeyHash, self[:])
}
...
func (self *Ed25519PublicKeyHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.Ed25519PublicKeyHash {
		return fmt.Errorf("gomav: invalid Ed25519PublicKeyHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *Secp256k1PublicKeyHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.Secp256k1PublicKeyHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self Secp256k1PublicKeyHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.Secp256k1PublicKeyHash, self[:])
}
...
func (self *Secp256k1PublicKeyHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.Secp256k1PublicKeyHash {
		return fmt.Errorf("gomav: invalid Secp256k1PublicKeyHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *P256PublicKeyHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.P256PublicKeyHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self P256PublicKeyHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.P256PublicKeyHash, self[:])
}
...
func (self *P256PublicKeyHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.P256PublicKeyHash {
		return fmt.Errorf("gomav: invalid P256PublicKeyHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *BLSPublicKeyHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.BLS12_381PublicKeyHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self BLSPublicKeyHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.BLS12_381PublicKeyHash, self[:])
}
...
func (self *BLSPublicKeyHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.BLS12_381PublicKeyHash {
		return fmt.Errorf("gomav: invalid BLSPublicKeyHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *ProtocolHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.ProtocolHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self ProtocolHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.ProtocolHash, self[:])
}
...
func (self *ProtocolHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.ProtocolHash {
		return fmt.Errorf("gomav: invalid ProtocolHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *ContractHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.ContractHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self ContractHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.ContractHash, self[:])
}
...
func (self *ContractHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.ContractHash {
		return fmt.Errorf("gomav: invalid ContractHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *Ed25519PublicKey) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.Ed25519PublicKey, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self Ed25519PublicKey) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.Ed25519PublicKey, self[:])
}
...
func (self *Ed25519PublicKey) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.Ed25519PublicKey {
		return fmt.Errorf("gomav: invalid Ed25519PublicKey encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *Secp256k1PublicKey) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.Secp256k1PublicKey, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self Secp256k1PublicKey) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.Secp256k1PublicKey, self[:])
}
...
func (self *Secp256k1PublicKey) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.Secp256k1PublicKey {
		return fmt.Errorf("gomav: invalid Secp256k1PublicKey encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *P256PublicKey) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.P256PublicKey, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self P256PublicKey) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.P256PublicKey, self[:])
}
...
func (self *P256PublicKey) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.P256PublicKey {
		return fmt.Errorf("gomav: invalid P256PublicKey encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *BLSPublicKey) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.BLS12_381PublicKey, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self BLSPublicKey) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.BLS12_381PublicKey, self[:])
}
...
func (self *BLSPublicKey) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.BLS12_381PublicKey {
		return fmt.Errorf("gomav: invalid BLSPublicKey encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *Ed25519PrivateKey) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.Ed25519Seed, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self Ed25519PrivateKey) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.Ed25519Seed, self[:])
}
...
func (self *Ed25519PrivateKey) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.Ed25519Seed {
		return fmt.Errorf("gomav: invalid Ed25519PrivateKey encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *Secp256k1PrivateKey) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.Secp256k1SecretKey, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self Secp256k1PrivateKey) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.Secp256k1SecretKey, self[:])
}
...
func (self *Secp256k1PrivateKey) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.Secp256k1SecretKey {
		return fmt.Errorf("gomav: invalid Secp256k1PrivateKey encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *P256PrivateKey) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.P256SecretKey, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self P256PrivateKey) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.P256SecretKey, self[:])
}
...
func (self *P256PrivateKey) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.P256SecretKey {
		return fmt.Errorf("gomav: invalid P256PrivateKey encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *BLSPrivateKey) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.BLS12_381SecretKey, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self BLSPrivateKey) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.BLS12_381SecretKey, self[:])
}
...
func (self *BLSPrivateKey) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.BLS12_381SecretKey {
		return fmt.Errorf("gomav: invalid BLSPrivateKey encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *Ed25519EncryptedPrivateKey) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.Ed25519EncryptedSeed, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self Ed25519EncryptedPrivateKey) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.Ed25519EncryptedSeed, self[:])
}
...
func (self *Ed25519EncryptedPrivateKey) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.Ed25519EncryptedSeed {
		return fmt.Errorf("gomav: invalid Ed25519EncryptedPrivateKey encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *Secp256k1EncryptedPrivateKey) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.Secp256k1EncryptedSecretKey, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self Secp256k1EncryptedPrivateKey) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.Secp256k1EncryptedSecretKey, self[:])
}
...
func (self *Secp256k1EncryptedPrivateKey) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.Secp256k1EncryptedSecretKey {
		return fmt.Errorf("gomav: invalid Secp256k1EncryptedPrivateKey encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *P256EncryptedPrivateKey) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.P256EncryptedSecretKey, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self P256EncryptedPrivateKey) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.P256EncryptedSecretKey, self[:])
}
...
func (self *P256EncryptedPrivateKey) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.P256EncryptedSecretKey {
		return fmt.Errorf("gomav: invalid P256EncryptedPrivateKey encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *BLSEncryptedPrivateKey) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.BLS12_381EncryptedSecretKey, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self BLSEncryptedPrivateKey) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.BLS12_381EncryptedSecretKey, self[:])
}
...
func (self *BLSEncryptedPrivateKey) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.BLS12_381EncryptedSecretKey {
		return fmt.Errorf("gomav: invalid BLSEncryptedPrivateKey encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *GenericSignature) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.GenericSignature, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self GenericSignature) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.GenericSignature, self[:])
}
...
func (self *GenericSignature) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.GenericSignature {
		return fmt.Errorf("gomav: invalid GenericSignature encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *Ed25519Signature) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.Ed25519Signature, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self Ed25519Signature) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.Ed25519Signature, self[:])
}
...
func (self *Ed25519Signature) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.Ed25519Signature {
		return fmt.Errorf("gomav: invalid Ed25519Signature encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *Secp256k1Signature) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.Secp256k1Signature, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self Secp256k1Signature) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.Secp256k1Signature, self[:])
}
...
func (self *Secp256k1Signature) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.Secp256k1Signature {
		return fmt.Errorf("gomav: invalid Secp256k1Signature encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *P256Signature) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.P256Signature, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self P256Signature) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.P256Signature, self[:])
}
...
func (self *P256Signature) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.P256Signature {
		return fmt.Errorf("gomav: invalid P256Signature encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *BLSSignature) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.BLS12_381Signature, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self BLSSignature) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.BLS12_381Signature, self[:])
}
...
func (self *BLSSignature) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.BLS12_381Signature {
		return fmt.Errorf("gomav: invalid BLSSignature encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *BlindedPublicKeyHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.BlindedPublicKeyHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self BlindedPublicKeyHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.BlindedPublicKeyHash, self[:])
}
...
func (self *BlindedPublicKeyHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.BlindedPublicKeyHash {
		return fmt.Errorf("gomav: invalid BlindedPublicKeyHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *TXRollupAddress) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.TXRollupAddress, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self TXRollupAddress) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.TXRollupAddress, self[:])
}
...
func (self *TXRollupAddress) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.TXRollupAddress {
		return fmt.Errorf("gomav: invalid TXRollupAddress encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *ZkRollupAddress) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.ZkRollupHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self ZkRollupAddress) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.ZkRollupHash, self[:])
}
...
func (self *ZkRollupAddress) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.ZkRollupHash {
		return fmt.Errorf("gomav: invalid ZkRollupAddress encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *DALCommitment) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.SlotHeader, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self DALCommitment) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.SlotHeader, self[:])
}
...
func (self *DALCommitment) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.SlotHeader {
		return fmt.Errorf("gomav: invalid DALCommitment encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *ScriptExprHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.ScriptExpr, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self ScriptExprHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.ScriptExpr, self[:])
}
...
func (self *ScriptExprHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.ScriptExpr {
		return fmt.Errorf("gomav: invalid ScriptExprHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *SmartRollupAddress) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.SmartRollupHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self SmartRollupAddress) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.SmartRollupHash, self[:])
}
...
func (self *SmartRollupAddress) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.SmartRollupHash {
		return fmt.Errorf("gomav: invalid SmartRollupAddress encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *SmartRollupStateHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.SmartRollupStateHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self SmartRollupStateHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.SmartRollupStateHash, self[:])
}
...
func (self *SmartRollupStateHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.SmartRollupStateHash {
		return fmt.Errorf("gomav: invalid SmartRollupStateHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *SmartRollupCommitmentHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.SmartRollupCommitmentHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self SmartRollupCommitmentHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.SmartRollupCommitmentHash, self[:])
}
...
func (self *SmartRollupCommitmentHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.SmartRollupCommitmentHash {
		return fmt.Errorf("gomav: invalid SmartRollupCommitmentHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *ScRollupAddress) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.ScRollupHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self ScRollupAddress) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.ScRollupHash, self[:])
}
...
func (self *ScRollupAddress) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.ScRollupHash {
		return fmt.Errorf("gomav: invalid ScRollupAddress encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *ScRollupStateHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.ScRollupStateHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self ScRollupStateHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.ScRollupStateHash, self[:])
}
...
func (self *ScRollupStateHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.ScRollupStateHash {
		return fmt.Errorf("gomav: invalid ScRollupStateHash encoding")
	}
	copy(self[:], payload)
	return nil
}
...
func (self *ScRollupCommitmentHash) ToBase58() []byte {
	out, err := base58.EncodeMV(&prefix.ScRollupCommitmentHash, self[:])
	if err != nil {
		panic(err)
	}
	return out
...
func (self ScRollupCommitmentHash) MarshalText() ([]byte, error) {
	return base58.EncodeMV(&prefix.ScRollupCommitmentHash, self[:])
}
...
func (self *ScRollupCommitmentHash) UnmarshalText(src []byte) error {
	...
	if pre != &prefix.ScRollupCommitmentHash {
		return fmt.Errorf("gomav: invalid ScRollupCommitmentHash encoding")
	}
	copy(self[:], payload)
	return nil
}
