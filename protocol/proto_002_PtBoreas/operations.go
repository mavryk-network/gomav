...
type DoubleAttestationEvidence = proto_001_PtAtLas.DoubleAttestationEvidence
type DoubleBakingEvidence = proto_001_PtAtLas.DoubleBakingEvidence
...
type DoublePreattestationEvidence = proto_001_PtAtLas.DoublePreattestationEvidence
...
type Preattestation = proto_001_PtAtLas.Preattestation
type Attestation = proto_001_PtAtLas.Attestation
...
type AttestationWithDAL struct {
	Attestation
	DALAttestation mv.BigInt `json:"dal_attestation"`
}
...
type DALSlotHeader struct {
	...
	CommitmentProof *mv.Bytes96       `json:"commitment_proof"`
}
