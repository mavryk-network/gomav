...
import (
	...
	expr "github.com/mavryk-network/gomav/v2/protocol/core/expression"
	...
	testCases := []testCase{
		{
			...
			expect: &ActivateAccount{
				PKH:    &mv.Ed25519PublicKeyHash{0xc5, 0x5c, 0xf0, 0x2d, 0xbe, 0xec, 0xc9, 0x78, 0xd9, 0xc8, 0x46, 0x25, 0xdc, 0xae, 0x72, 0xbb, 0x77, 0xea, 0x4f, 0xbd},
				Secret: &mv.Bytes20{0x41, 0xf9, 0x8b, 0x15, 0xef, 0xc6, 0x3f, 0xa8, 0x93, 0xd6, 0x1d, 0x7d, 0x6e, 0xee, 0x4a, 0x2c, 0xe9, 0x42, 0x7a, 0xc4},
			},
		},
		{
		...
		},
		{
			...
			kind:  "ballot",
			expect: &Ballot{
				Source: &mv.Ed25519PublicKeyHash{0x2, 0x29, 0x8c, 0x3, 0xed, 0x7d, 0x45, 0x4a, 0x10, 0x1e, 0xb7, 0x2, 0x2b, 0xc9, 0x5f, 0x7e, 0x5f, 0x41, 0xac, 0x78},
				Period: 719,
		...
		},
		{
			...
			expect: &Delegation{
				...
				Delegate: mv.Some[mv.PublicKeyHash](&mv.Ed25519PublicKeyHash{0x2, 0x29, 0x8c, 0x3, 0xed, 0x7d, 0x45, 0x4a, 0x10, 0x1e, 0xb7, 0x2, 0x2b, 0xc9, 0x5f, 0x7e, 0x5f, 0x41, 0xac, 0x78}),
			},
		},
		{
			title: "proposals",
			...
			kind:  "proposals",
			expect: &Proposals{
				Source: &mv.Ed25519PublicKeyHash{0x94, 0x25, 0x8, 0x6a, 0x67, 0xfd, 0xe5, 0xa0, 0xf, 0xac, 0xd4, 0x2f, 0xba, 0x4f, 0x2d, 0x27, 0x63, 0xa3, 0xd5, 0xe5},
				Period: 82,
				Proposals: []*mv.ProtocolHash{{
		...
		},
		{
			...
			expect: &Reveal{
				ManagerOperation: ManagerOperation{
					...
					Fee:          mv.BigUint{0xe7, 0x2},
					Counter:      mv.BigUint{0xcb, 0x96, 0xb},
					GasLimit:     mv.BigUint{0xe8, 0x7},
					StorageLimit: mv.BigUint{0x0},
				},
				PublicKey: &mv.Ed25519PublicKey{
				...
				Block1: BlockHeader{
					UnsignedBlockHeader: UnsignedBlockHeader{
						ShellHeader: core.ShellHeader{
							Level:          3365599,
							Proto:          0x10,
							Predecessor:    &mv.BlockHash{0x13, 0x51, 0x16, 0xe4, 0x5c, 0xe4, 0xfb, 0xe, 0xfe, 0x9e, 0x22, 0x65, 0x14, 0x43, 0x42, 0xf6, 0x55, 0xaa, 0xe0, 0xe3, 0x69, 0x2c, 0x55, 0xe0, 0xcd, 0x1f, 0x18, 0x2f, 0x7a, 0xba, 0xb4, 0x1b},
							Timestamp:      1681585180,
							ValidationPass: 0x4,
							OperationsHash: &mv.OperationsHash{0xd0, 0xf7, 0x1, 0x62, 0x10, 0x67, 0xac, 0x4f, 0xdc, 0x6a, 0x9f, 0x28, 0xf5, 0x48, 0xc9, 0x42, 0xae, 0x2f, 0xcb, 0xea, 0x2a, 0xd0, 0x2f, 0xc4, 0x7f, 0xf1, 0xe9, 0x63, 0xf6, 0x44, 0x0, 0xd5},
							...
							Context:        &mv.ContextHash{0x5f, 0x38, 0x12, 0xe5, 0x27, 0x5, 0x5f, 0x60, 0x56, 0xd3, 0x9d, 0xe5, 0x56, 0x65, 0xa1, 0x8, 0x3b, 0x81, 0xc, 0xdf, 0xb4, 0xa0, 0x49, 0xb1, 0xe8, 0xda, 0x79, 0xc3, 0xc7, 0x6, 0xfd, 0xfd},
						},
						UnsignedProtocolBlockHeader: UnsignedProtocolBlockHeader{
							PayloadHash:               &mv.BlockPayloadHash{0x9f, 0xbe, 0xca, 0xa, 0xca, 0xc7, 0x85, 0xd8, 0x7b, 0xb7, 0xd1, 0x77, 0x55, 0x3d, 0xb3, 0x4, 0x3a, 0xff, 0x67, 0x59, 0xbe, 0xb9, 0xdb, 0x3b, 0x66, 0x19, 0xfc, 0x12, 0x91, 0x62, 0xac, 0x75},
							PayloadRound:              0,
							ProofOfWorkNonce:          &mv.Bytes8{0x59, 0x77, 0xcc, 0x15, 0xeb, 0x11, 0x0, 0x0},
							SeedNonceHash:             mv.None[*mv.CycleNonceHash](),
							LiquidityBakingToggleVote: core.LiquidityBakingPass,
						},
					},
					Signature: mv.AnySignature{0xda, 0xfc, 0xfb, 0x71, 0xf5, 0x87, 0x51, 0x9a, 0xd2, 0xf, 0xdf, 0xf8, 0xde, 0x4e, 0xc3, 0xd6, 0xaa, 0x2b, 0xfa, 0xd8, 0x15, 0xac, 0x12, 0x96, 0x1e, 0x4a, 0x4b, 0x7, 0x36, 0xf0, 0x1, 0x93, 0xda, 0x9, 0xe9, 0xd7, 0xb0, 0xa1, 0xf8, 0x78, 0x37, 0xcc, 0xd1, 0x87, 0xa2, 0x60, 0x64, 0x67, 0x38, 0x5b, 0x26, 0xb8, 0x54, 0xb4, 0x37, 0x5c, 0x79, 0x37, 0xdc, 0x49, 0xa2, 0x2f, 0x53, 0xf2},
				},
				Block2: BlockHeader{
					UnsignedBlockHeader: UnsignedBlockHeader{
						ShellHeader: core.ShellHeader{
		...
		},
		{
			...
			expect: &Transaction{
				...
				Parameters: mv.Some(Parameters{
					Entrypoint: EpNamed{String: "fulfill_ask"},
					Value: &expr.Prim20{
						Prim: 7,
						Args: [2]expr.Expression{
							expr.Int{Int: mv.BigInt{0x88, 0xf0, 0xf6, 0x01}},
							expr.Prim00(6),
						},
					},
				}),
		...
		},
		{
			...
			expect: &Origination{
				ManagerOperation: ManagerOperation{
					...
					Fee:          mv.BigUint{0x99, 0xb},
					Counter:      mv.BigUint{0xc9, 0x85, 0xee, 0x2a},
					GasLimit:     mv.BigUint{0xdd, 0xe},
					StorageLimit: mv.BigUint{0x9e, 0xa},
				},
				Balance:  mv.BigUint{0x0},
				Delegate: mv.None[mv.PublicKeyHash](),
				Script: Script{
					Code: expr.Seq{
		...
		},
		{
			...
			expect: &RegisterGlobalConstant{
				ManagerOperation: ManagerOperation{
					Source: &mv.Secp256k1PublicKeyHash{
						0x99, 0x65, 0xcc, 0xdb, 0xa0, 0xe, 0x7a, 0xe3, 0xa7, 0x3a, 0xd5, 0x13, 0xcd, 0x31, 0x5a,
						0x1a, 0x59, 0xe5, 0x7f, 0x82,
					},
					Fee:          mv.BigUint{0xe3, 0x3},
					Counter:      mv.BigUint{0xf9, 0xed, 0xae, 0x5},
					GasLimit:     mv.BigUint{0xb6, 0xa},
					StorageLimit: mv.BigUint{0x50},
				},
				Value: &expr.Prim1X{
					Prim:   expr.Prim_list,
		...
		},
		{
			...
			expect: &SetDepositsLimit{
				ManagerOperation: ManagerOperation{
					...
					Fee:          mv.BigUint{0xcd, 0x2},
					Counter:      mv.BigUint{0x84, 0x9b, 0xea, 0x8},
					GasLimit:     mv.BigUint{0xe8, 0x7},
					StorageLimit: mv.BigUint{0x0},
				},
				Limit: mv.Some(mv.BigUint{0x80, 0xb2, 0xa7, 0xad, 0x27}),
			},
		},
		{
			...
			expect: &IncreasePaidStorage{
				ManagerOperation: ManagerOperation{
					...
					Fee:          mv.BigUint{0x93, 0x3},
					Counter:      mv.BigUint{0xf7, 0x82, 0xb},
					GasLimit:     mv.BigUint{0xcc, 0x8},
					StorageLimit: mv.BigUint{0x0},
				},
				Amount: mv.BigInt{0x1},
				Destination: core.OriginatedContract{
					ContractHash: &mv.ContractHash{
		...
		},
		{
			...
			expect: &UpdateConsensusKey{
				ManagerOperation: ManagerOperation{
					...
					Fee:          mv.BigUint{0x98, 0x3},
					Counter:      mv.BigUint{0xf6, 0x82, 0xb},
					GasLimit:     mv.BigUint{0xcc, 0x8},
					StorageLimit: mv.BigUint{0x0},
				},
				PublicKey: &mv.P256PublicKey{
