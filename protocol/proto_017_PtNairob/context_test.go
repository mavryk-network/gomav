...
func TestDelegateInfo(t *testing.T) {
	...
	expect := DelegateInfo{
		FullBalance:           mv.BigUint{0xf9, 0xa8, 0xc0, 0x98, 0xe6, 0x40},
		CurrentFrozenDeposits: mv.BigUint{0xd0, 0x83, 0x9c, 0xc0, 0x9e, 0x35},
		FrozenDeposits:        mv.BigUint{0xd0, 0x83, 0x9c, 0xc0, 0x9e, 0x35},
		StakingBalance:        mv.BigUint{0x86, 0xc4, 0xa4, 0xf6, 0xc4, 0x8f, 0x4},
		FrozenDepositsLimit:   mv.None[mv.BigUint](),
		DelegatedContracts: []core.ContractID{
			core.OriginatedContract{
				ContractHash: &mv.ContractHash{0xf1, 0x87, 0xe5, 0x51, 0xa5, 0xca, 0xd3, 0xc8, 0x72, 0x77, 0x2, 0x34, 0x35, 0xe1, 0xb5, 0xa2, 0xa1, 0x9c, 0x8c, 0x82},
				Padding:      0x0,
			},
			core.OriginatedContract{
				ContractHash: &mv.ContractHash{0xaf, 0xaf, 0x37, 0x26, 0xc, 0x1a, 0x60, 0x41, 0x68, 0xbf, 0xdd, 0xc6, 0x91, 0xd4, 0x59, 0xde, 0x23, 0x3d, 0xe3, 0x5c},
				Padding:      0x0,
			},
			core.OriginatedContract{
				ContractHash: &mv.ContractHash{0xab, 0x6a, 0x68, 0x33, 0x98, 0xd0, 0x67, 0x63, 0xe1, 0x5e, 0xd9, 0xd, 0x6a, 0x99, 0x58, 0x2e, 0x97, 0x4f, 0x79, 0xea},
				Padding:      0x0,
			},
			core.OriginatedContract{
				ContractHash: &mv.ContractHash{0x8f, 0x20, 0x8e, 0x66, 0xc5, 0x90, 0x34, 0x8f, 0xf8, 0xef, 0x1d, 0xf6, 0x4a, 0xd, 0x57, 0x30, 0xa3, 0x58, 0xa7, 0xe0},
				Padding:      0x0,
			},
			core.OriginatedContract{
				ContractHash: &mv.ContractHash{0x67, 0xc1, 0xb5, 0x2f, 0x7c, 0xf1, 0xea, 0xa1, 0xe7, 0x67, 0xa5, 0x39, 0x1d, 0x5b, 0x87, 0xea, 0x93, 0x91, 0xf7, 0x2d},
				Padding:      0x0,
			},
			core.OriginatedContract{
				ContractHash: &mv.ContractHash{0x36, 0x82, 0x76, 0x73, 0xea, 0x8a, 0x53, 0xce, 0x36, 0x91, 0xf2, 0x33, 0x49, 0x2b, 0x44, 0xbe, 0x1, 0xf0, 0x9, 0x4},
				Padding:      0x0,
			},
			core.OriginatedContract{
				ContractHash: &mv.ContractHash{0x34, 0x89, 0xd4, 0x7a, 0x99, 0x73, 0xe3, 0x1a, 0xa4, 0x41, 0xe0, 0x2a, 0x93, 0x8e, 0x5c, 0x59, 0x40, 0xa7, 0x46, 0x6c},
				Padding:      0x0,
			},
			core.OriginatedContract{
				ContractHash: &mv.ContractHash{0x29, 0x93, 0xc1, 0xa1, 0xbb, 0xa3, 0x22, 0x72, 0x71, 0xef, 0x7b, 0xae, 0x29, 0x82, 0x25, 0xf9, 0xde, 0x10, 0xcd, 0x7b},
				Padding:      0x0,
			},
			core.OriginatedContract{
				ContractHash: &mv.ContractHash{0x22, 0x61, 0xda, 0x9f, 0x57, 0x55, 0xed, 0x2c, 0x8d, 0xe5, 0x4e, 0x3b, 0x6b, 0xb, 0x62, 0xdd, 0xe, 0x9, 0x60, 0xb8},
				Padding:      0x0,
			},
			core.OriginatedContract{
				ContractHash: &mv.ContractHash{0x18, 0x14, 0x2c, 0x7c, 0x24, 0x52, 0xdf, 0xed, 0x9e, 0xc7, 0x7c, 0x89, 0x1e, 0x89, 0x7a, 0xc6, 0x8f, 0x22, 0x83, 0x3b},
				Padding:      0x0,
			},
			core.OriginatedContract{
				ContractHash: &mv.ContractHash{0xb, 0xd7, 0xc6, 0xd1, 0x51, 0x70, 0x66, 0xc4, 0x9f, 0x74, 0x7c, 0xfd, 0xf6, 0x32, 0xff, 0x95, 0xd7, 0x4d, 0xa9, 0x12},
				Padding:      0x0,
			},
			core.ImplicitContract{
				PublicKeyHash: &mv.P256PublicKeyHash{0xe1, 0x94, 0x71, 0xe8, 0x61, 0x1f, 0xcb, 0x3, 0xc3, 0x4c, 0x45, 0x99, 0xb0, 0x19, 0xc9, 0xc8, 0x68, 0x67, 0xb4, 0x47},
			},
			core.ImplicitContract{
				PublicKeyHash: &mv.Secp256k1PublicKeyHash{0x7a, 0x6, 0x13, 0x3e, 0x82, 0x4b, 0xf3, 0x62, 0xf2, 0x17, 0xf, 0x91, 0x3c, 0x97, 0x16, 0x28, 0x51, 0xbb, 0x30, 0xfd},
			},
			core.ImplicitContract{
				PublicKeyHash: &mv.Ed25519PublicKeyHash{0x2a, 0x46, 0xca, 0x4, 0x2d, 0xb4, 0x1a, 0x95, 0xfe, 0x6, 0x82, 0x92, 0x59, 0x5c, 0x55, 0x51, 0x2, 0xdb, 0xf4, 0x21},
			},
		},
		DelegatedBalance:     mv.BigUint{0x8d, 0x9b, 0xe4, 0xdd, 0xde, 0xce, 0x3},
		Deactivated:          false,
		GracePeriod:          629,
		VotingPower:          mv.Some(int64(18121953297364)),
		CurrentBallot:        mv.None[core.BallotKind](),
		CurrentProposals:     []*mv.ProtocolHash{},
		RemainingProposals:   20,
		ActiveConsensusKey:   &mv.P256PublicKeyHash{0xe1, 0x94, 0x71, 0xe8, 0x61, 0x1f, 0xcb, 0x3, 0xc3, 0x4c, 0x45, 0x99, 0xb0, 0x19, 0xc9, 0xc8, 0x68, 0x67, 0xb4, 0x47},
...
func TestConstants(t *testing.T) {
	...
	expect := Constants{
		...
		HardGasLimitPerBlock:                             mv.BigInt{0x80, 0xb1, 0xbd, 0x2},
		ProofOfWorkThreshold:                             281474976710655,
		MinimalStake:                                     mv.BigUint{0x80, 0xf8, 0x82, 0xad, 0x16},
		VDFDifficulty:                                    8000000000,
		SeedNonceRevelationTip:                           mv.BigUint{0xc8, 0xd0, 0x7},
		OriginationSize:                                  257,
		BakingRewardFixedPortion:                         mv.BigUint{0xc0, 0x96, 0xb1, 0x2},
		BakingRewardBonusPerSlot:                         mv.BigUint{0xdf, 0x10},
		EndorsingRewardPerSlot:                           mv.BigUint{0x94, 0xb},
		CostPerByte:                                      mv.BigUint{0xfa, 0x1},
		HardStorageLimitPerOperation:                     mv.BigInt{0xa0, 0xa9, 0x7},
		QuorumMin:                                        2000,
		QuorumMax:                                        7000,
		MinProposalQuorum:                                500,
		LiquidityBakingSubsidy:                           mv.BigUint{0xd0, 0xa5, 0x4c},
		...
		DoubleBakingPunishment:                           mv.BigUint{0x80, 0xc0, 0x96, 0xb1, 0x2},
		RatioOfFrozenDepositsSlashedPerDoubleEndorsement: core.Rat{0x1, 0x2},
		TestnetDictator:                                  mv.None[mv.PublicKeyHash](),
		InitialSeed:                                      mv.None[*mv.Bytes32](),
		...
		TxRollupCommitmentBond:                           mv.BigUint{0x80, 0xc8, 0xaf, 0xa0, 0x25},
